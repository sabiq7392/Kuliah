 ...
 */
const index = () => fruits.forEach((fruit) => console.log(fruit))
 ...
 */
const store = (name) => fruits.push(name);
 ...
 */
const update = (position, name) => fruits[position] = name;
 ...
 */
const destroy = (position) => fruits.splice(position, 1);
